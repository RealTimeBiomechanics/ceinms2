...
fiberForce,fiberLength, musculotendonLength," "normalisedFiberLength,
normalisedFiberLengthAtT, normalisedFiberVelocity, optimalFiberLengthAtT,"
                "passiveForce, pennationAngle, tendonLength, tendonStrain, fa,
fv, fp" << endl; DoubleT flStart = 0.1, flStop = 1.9; const unsigned N = 100;
...
void testAutoDiff(ceinms::Lloyd2019Muscle& muscle) {
        ...
        cout << u << endl;
        dual dudfl = derivative([&](auto x1, auto x2, auto x3) {return
muscle.calculateFiberForce(x1, x2, x3); }, wrt(fl), a, fl, fv); cout <<
"automatic derivative: " << dudfl << endl;
